...
window.renderizarEquipe = function () {
  ...
  lista.innerHTML = eq.map((m, i) => {
    ...
    return `<tr style="background:${bgRow};border-bottom:1px solid var(--c-border-lt);font-size:.78rem;">
      <td data-label="MEMBRO" style="padding:8px 12px;text-align:center;font-weight:700;color:var(--c-pine);border-right:1px solid var(--c-border-lt);white-space:nowrap;">${String(i + 1).padStart(3, '0')}</td>
      <td data-label="NOME COMPLETO" style="padding:8px 12px;font-weight:700;color:var(--c-text);border-right:1px solid var(--c-border-lt);">${m.nome || '—'}</td>
      <td data-label="CPF" style="padding:8px 12px;text-align:center;border-right:1px solid var(--c-border-lt);white-space:nowrap;font-family:monospace;font-size:.75rem;">${m.cpf || '—'}</td>
      <td data-label="DATA DE NASCIMENTO" style="padding:8px 12px;text-align:center;border-right:1px solid var(--c-border-lt);white-space:nowrap;">${nasc}</td>
      <td data-label="FUNÇÃO / CARGO" style="padding:8px 12px;color:var(--c-fern);font-weight:600;border-right:1px solid var(--c-border-lt);">${cargo}</td>
      <td data-label="CREA / CFB" style="padding:8px 12px;text-align:center;border-right:1px solid var(--c-border-lt);white-space:nowrap;">${m.crea_cfb || '—'}</td>
      <td data-label="DDD / CELULAR" style="padding:8px 12px;text-align:center;border-right:1px solid var(--c-border-lt);white-space:nowrap;">${m.celular || '—'}</td>
      <td data-label="E-MAIL" style="padding:8px 12px;border-right:1px solid var(--c-border-lt);font-size:.75rem;">${m.email || '—'}</td>
      <td data-label="AÇÕES" style="padding:8px 12px;text-align:center;white-space:nowrap;">
